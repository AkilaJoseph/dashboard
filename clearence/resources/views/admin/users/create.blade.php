...
<div class="glow-card" style="padding:0;overflow:hidden;">
    ...
    <div style="padding:18px 26px;border-bottom:1px solid rgba(16,185,129,0.12);background:rgba(16,185,129,0.04);">
        <div style="display:flex;align-items:center;gap:12px;">
            <div style="width:38px;height:38px;border-radius:9px;background:linear-gradient(135deg,#059669,#10b981);display:flex;align-items:center;justify-content:center;box-shadow:0 0 18px rgba(16,185,129,0.4);">
                <svg style="width:16px;height:16px;color:#020904;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
            </div>
            <div>
                <h3 style="font-size:14px;font-weight:800;color:#e2e8f0;">New User Registration</h3>
                <p style="font-size:11px;color:rgba(160,200,175,0.45);">Mbeya University of Science and Technology</p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.users.store') }}" style="padding:26px;" id="userForm">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-bottom:18px;">
            ...
            <div>
                <label style="display:block;font-size:11px;font-weight:700;color:rgba(52,211,153,0.7);letter-spacing:0.06em;text-transform:uppercase;margin-bottom:7px;">Email Address <span style="color:#ef4444;">*</span></label>
                <input type="email" name="email" required value="{{ old('email') }}" class="glow-input" style="width:100%;" placeholder="user@must.ac.tz">
            </div>
            <div>
                <label style="display:block;font-size:11px;font-weight:700;color:rgba(52,211,153,0.7);letter-spacing:0.06em;text-transform:uppercase;margin-bottom:7px;">Phone Number</label>
            ...
            <div>
                <label style="display:block;font-size:11px;font-weight:700;color:rgba(52,211,153,0.7);letter-spacing:0.06em;text-transform:uppercase;margin-bottom:7px;">Password <span style="color:#ef4444;">*</span></label>
        ...
        <div id="officerFields" style="{{ old('role')!=='officer' ? 'display:none;' : '' }}">
            <div style="border-top:1px solid rgba(16,185,129,0.1);padding-top:18px;margin-bottom:18px;">
                ...
                <div>
                    <label style="display:block;font-size:11px;font-weight:700;color:rgba(52,211,153,0.7);letter-spacing:0.06em;text-transform:uppercase;margin-bottom:7px;">Assign Department <span style="color:#ef4444;">*</span></label>
